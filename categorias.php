...
<div class="row">
		...
		<div class="col-md-6">
			<div class="col-md-4">
				<a href="#"><img src="img/<?= $id; ?>.jpg" onclick="ampliar_imagem('ampliar.php?codigo=<?= $id; ?>&nome=<?= $descricao; ?>','','width=522,height=338,top=50,left=50')" width="140" height="85" border="0" />
				</a> <br />
